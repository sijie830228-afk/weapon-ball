...
const ROSTER = {
          ...
          carrie: { id:'carrie', faction:'TimeAdmin', name:'奧恩斯·凱瑞', title:'坦克 / 蓄壓反擊', color:'#4A6FA5', mass:1.8, desc:'【性相】型之性相\n【被動】承傷轉壓力，越高減傷越高。【主動】壓力滿(3層)放彈片。【成長】提升彈片傷害。',
          ...
          melis: { id:'melis', faction:'TimeAdmin', name:'梅樂絲·布雷茲', title:'元素 / 範圍灼燒', color:'#FF6B35', mass:1.0, desc:'【性相】氳之性相\n【被動】召喚火靈，附加燃燒。【主動】致死免疫，擴散火環引爆燃燒。【成長】提升燃燒秒傷。',
          ...
          eli: { id:'eli', faction:'TimeAdmin', name:'伊萊·萊特', title:'機動 / 劍環聯動', color:'#E0FAFF', mass:0.9, desc:'【性相】啟之性相\n【被動】真理劍環繞洞穿敵人。【主動】碰撞發螺旋環刃。【成長】命中增加環刃數量與傷害。\n【聯動】三菱鏡。',
          ...
          thoth: { id:'thoth', faction:'TimeAdmin', name:'托特·歐珀', title:'重擊 / 質量積累', color:'#5B5F66', mass:1.8, radiusMult:1.2, desc:'【性相】型之性相\n【被動】碰撞加質量擊退。【主動】預瞄發射光束。【成長】3層質量傷+1。',
          ...
          cetus: { id:'cetus', faction:'TimeAdmin', name:'塞特斯', title:'控制 / 規則懲戒', color:'#8A2BE2', mass:1.1, desc:'【性相】啟之性相\n【被動】免疫警告目標傷害，飛撞引爆定罪。【主動】發射法令附加警告。',
          ...
          ino: { id:'ino', faction:'TimeAdmin', name:'銀諾·諾克薩斯', title:'遠程 / 穿透彈射', color:'#00B4D8', mass:0.9, desc:'【性相】氳之性相\n【被動】鳥穿透敵人。【主動】發射鳥物理傷害。【成長】增加彈射次數。',
          ...
          kate: { id:'kate', faction:'TimeAdmin', name:'奧恩斯·凱特', title:'工事 / 能量牽引', color:'#D95D39', mass:1.1, desc:'【性相】型之性相\n【被動】雷射牆切割敵人。【主動】觸壁結牆(最多3道)。',
          ...
          isaac: { id:'isaac', faction:'TimeAdmin', name:'以撒·薩恩', title:'法術 / 條件爆發', color:'#E2E8F0', mass:1.0, desc:'【性相】意之性相\n【被動】8秒發律令乘算效果。【主動】血小於35%湧出大量物理殘影。\n【聯動】三菱鏡。',
          ...
          olynx: { id:'olynx', faction:'TimeAdmin', name:'奧林克斯', title:'煉金 / 原料轉化', color:'#A0522D', mass:1.1, desc:'【性相】型之性相\n【被動】碰牆滿3層隨機發射武器。【成長】累積發射增道具時間。',
          ...
          topiharin: { id:'topiharin', faction:'DivineCathedral', name:'托匹哈鈴', title:'音律 / 階段演進', color:'#FF1493', mass:1.0, desc:'【性相】氳之性相\n【被動】每15秒切換樂章。【主動】敵方進入特定範圍受懲戒。\n【聯動】三菱鏡。',
          ...
          miller: { id:'miller', faction:'DivineCathedral', name:'米勒', title:'情感 / 慟哭閱讀', color:'#FBBF24', mass:1.0, desc:'【性相】沌之性相\n【被動】依血量發動四書：聖餐/降雨/召喚騎士。\n【主動】<25%依百分比持續治癒敵方，過量即死。\n【聯動】三菱鏡。',
          ...
          hao: { id:'hao', faction:'DivineCathedral', name:'昊', title:'畫家 / 潑墨天地', color:'#60A5FA', mass:1.0, desc:'【性相】沌之性相\n【被動】行走改變顏料藍->黃->綠。【終幕】紅相巨型化、3倍速衝撞染紅全場。\n【聯動】三菱鏡。',
          ...
          creator: { id:'creator', faction:'StorybookCommittee', name:'創世神', title:'永滅 / 權能複製', color:'#F8F9FA', mass:1.0, desc:'【性相】秘之性相\n【被動】等待5秒後複製敵方機制。\n【強化】基礎數值乘二但無成長。',
          ...
          anonymous: { id:'anonymous', faction:'StorybookCommittee', name:'佚名', title:'永滅 / 扉頁箴言', color:'#D1D5DB', mass:1.0, desc:'【性相】意之性相\n【被動】全場失血化記憶強化技能。\n【主動】隨機箴言(雷射/恢復/圓環)。',
          ...
          ocalis: { id:'ocalis', faction:'StorybookCommittee', name:'奧卡利斯', title:'永滅 / 必然收束', color:'#9CA3AF', mass:0.5, radiusMult:0.6, desc:'【性相】啟之性相\n【被動】化為衛星環繞減傷。\n【主動】扣除目標5%最大生命。',
          ...
          podoasg: { id:'podoasg', faction:'StorybookCommittee', name:'波多亞斯格', title:'永滅 / 委員會召喚', color:'#F1F5F9', mass:1.0, desc:'【性相】秘之性相\n【被動】開局空白，定期放牆。【終幕】隊友死盡召喚夥伴並親自下場。',
          ...
          fasimir: { id:'fasimir', faction:'TomorrowCompany', name:'法西米爾·箭頭', title:'本質 / 赫萊森', color:'#38BDF8', mass:1.0, desc:'【性相】型之性相\n【被動】建赫萊森域。【主動】賦予神器。\n【聯動】ECMO: 阿斯克勒庇俄斯的蛇杖。\n【終幕】10次後化為場地極高質量雷池。',
          ...
          lisi: { id:'lisi', faction:'TomorrowCompany', name:'李斯', title:'本質 / 明日新聞', color:'#F472B6', mass:1.0, desc:'【性相】意之性相\n【被動】閃光燈照相傷害。【主動】大新聞記錄全場，受擊喚出狂熱粉絲。【回溯】5秒後回溯狀態。\n【聯動】ECMO: 大新聞期間受擊依比例回血(可超量)。',
          ...
          ecmo: { id:'ecmo', faction:'TomorrowCompany', name:'ECMO', title:'醫療照護', color:'#10B981', mass:1.0, desc:'【性相】氳之性相\n【被動】承傷/造傷累積素材，每10秒扣10%血換10%素材。\n【主動】滿100增殖。上限後發生物電，敵方麻痺我方回血(可超量)。\n【聯動】解鎖隊友超量機制。',
          ...
          companion: { id:'companion', faction:'TomorrowCompany', name:'同行者', title:'軌道炮 / 渡魂機甲', color:'#67E8F9', mass:1.0, desc:'【性相】型之性相\n【被動】擁有三個軌道炮。每3秒各自索敵，向敵方發射持續1秒、逐漸向前延伸的激光，秒傷8。\n【變身】激光每造成20點傷害，變身渡魂機甲5秒：碰撞傷害、大小、質量翻倍，受到傷害與移動速度減半，獲得15點額外生命。\n【代價】渡魂機甲額外生命耗盡時，軌道炮癱瘓4秒。',
          ...
          grimm: { id:'grimm', faction:'AnchorOfDestiny', name:'格林·吉奧', title:'念核 / 『志』之錨', color:'#34D399', mass:1.1, desc:'【性相】沌之性相\n【被動】生念核。本體拾取化軌道；敵方拾取受傷；我方恢復。\n【主動】滿12顆收束巨劍，依累積受擊揮砍。',
          ...
          quzhe: { id:'quzhe', faction:'AnchorOfDestiny', name:'曲哲', title:'雙生 / 『象』之錨', color:'#059669', mass:1.0, desc:'【性相】穩之性相\n【被動】本體與虛影分擔血量，互通傷害治療。【主動】一死展無盡之境侵蝕。【反制】存活受擊生裂口交融。',
          ...
          piancha: { id:'piancha', faction:'AnchorOfDestiny', name:'偏差', title:'空間 / 『移』之錨', color:'#A855F7', mass:0.9, desc:'【性相】境之性相\n【被動】穿透牆壁生傳送門。【主動】受傷全地圖躍遷生門。【命路】死後轉負載，傳送門湮滅爆發負載傷害。',
          ...
          aclas: { id:'aclas', faction:'AnchorOfDestiny', name:'艾克拉斯·天輝', title:'誓約 / 『誓』之錨', color:'#000000', mass:1.0, desc:'【性相】穩之性相\n【被動】每秒生出紅綠藍色光(波包形態)。拾取改變自身顏色，上限各8層。\n【滿層質變】當單一色光達8層時，該屬性加成翻倍！\n【紅】動機：傷害，每層+4\n【綠】激發：擊退，每層+200\n【藍】能力：範圍，每層+20度\n【主動】每8秒釋放激光攻擊。\n【增幅】發射前根據總色光數乘2恢復血量。',
          ...
          daotuo: { id:'daotuo', faction:'AnchorOfDestiny', name:'稻陀', title:'命定之錨 / 『問』之錨', color:'#0EA5E9', mass:1.0,
            ...
            update: (b, eng) => {
              if((b.vortexTimer+=DT)>=7){
                b.vortexTimer=0;
                const target=eng.getNearestEnemy(b);
                let vvx, vvy;
                if(target){ const n=normalize(target.x-b.x,target.y-b.y); vvx=n.x*70; vvy=n.y*70; }
                else { const a=random()*PI*2; vvx=cos(a)*70; vvy=sin(a)*70; }
                eng.spawnObstacle({
                  type:'inquiry_vortex',
                  x:max(60,min(eng.arenaSize-60,b.x)), y:max(60,min(eng.arenaSize-60,b.y)),
                  vx:vvx, vy:vvy,
